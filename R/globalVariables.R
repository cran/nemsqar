utils::globalVariables(c(
  ...
  "RESPIRATORY_DISTRESS1",
  "RESPIRATORY_DISTRESS2",
  "RESPIRATORY_EFFORT",
  "RESPIRATORY_RATE_10",
  "SBP_10",
  "SCENE_DELAY",
  ...
  "VITALS_CHECK1",
  "VITALS_CHECK2",
  "adult_measure_performance",
  "adult_population",
  "adult_successful_intubation",
  "adult_successful_no_hypotension",
  "adult_successful_no_hypoxia",
  ...
  "numerator",
  "patient_age_in_days",
  "patient_age_in_days_col",
  "patient_age_in_years",
  "patient_age_in_years_col",
  "pedi_measure_performance",
  "pedi_population",
  "pedi_successful_intubation",
  "pedi_successful_no_hypotension",
  "pedi_successful_no_hypoxia",
  "procedure_order",
  "prop",
  "pull",
  "successful_no_hypotension",
  "successful_no_hypoxia",
  ...
  "system_age_minor2",
  "system_age_minor3",
  "system_age_minor_exclusion",
  "system_age_minor_exclusion1",
  ...
  "INCIDENT_DATE",
  "across",
  "airway_01_vitals_table",
  "airway_05_vitals_table",
  "first_procedure",
  ...
  "range_bounds_after",
  "range_bounds_before",
  "successful_procedure_data",
  "target_procedures",
  "within_range_after",
  "within_range_before",
  "SBP_threshold",
  "airway_after_procedure",
  "airway_after_procedure_waveform",
  "first_attempt",
  "first_successful_attempt",
  "numerator1_sbp",
  "numerator2_sbp",
  "vitals_after_procedure",
