testthat::test_that("safety_02 produces expected results", {
  # Synthetic test data
  ...
  # Run function
  result <- suppressWarnings(safety_02(
    df = test_data,
  ...
  testthat::expect_warning(safety_02(
    df = test_data,
    erecord_01_col = erecord_01,
    incident_date_col = NULL,
    patient_DOB_col = NULL,
  ...
  testthat::expect_true(all(
    c("measure", "pop", "numerator", "denominator", "prop", "prop_label") %in%
      names(result)
  ))
...
testthat::test_that("safety_02 handles missing data correctly", {
  # Synthetic test data
  missing_data <- tibble::tibble(
    ...
    epatient_16 = c("Years", "Years", "Years", "Months", "Years"),
    eresponse_05 = rep(2205001, 5),
    edisposition_18 = c(rep(4218015, 3), NA_integer_, NA_integer_),
    edisposition_28 = c(rep(4228001, 3), NA_integer_, NA_integer_),
    edisposition_30 = c(rep(4230001, 3), NA_integer_, NA_integer_)
  )
...
testthat::test_that("safety_02 returns empty result for non-matching criteria", {
  # Synthetic test data
  non_matching_data <- tibble::tibble(
    ...
    edisposition_18 = rep(4218015, 5),
    edisposition_28 = rep(4228001, 5),
    edisposition_30 = rep("car ride", 5)
  )
