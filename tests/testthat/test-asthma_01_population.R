...
testthat::test_that("asthma_01_population rejects non-dataframe inputs", {
  testthat::expect_error(
    nemsqar::asthma_01_population(df = list()),
    "One or more"
  )

  testthat::expect_error(
    nemsqar::asthma_01_population(patient_scene_table = matrix()),
    "One or more"
  )
...
testthat::test_that("asthma_01_population correctly classifies patient age", {
  ...
  result <- nemsqar::asthma_01_population(
    df,
    erecord_01_col = erecord_01,
    incident_date_col = incident_date,
    patient_DOB_col = patient_dob,
