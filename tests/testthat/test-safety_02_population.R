testthat::test_that("safety_02_population rejects invalid argument combinations", {

  testthat::expect_error(safety_02_population(df = tibble::tibble(),
  ...
  testthat::expect_error(safety_02_population(patient_scene_table = list(),
                                              response_table = tibble::tibble(),
                                              disposition_table = tibble::tibble(),
                                              erecord_01_col = character(),
                                              incident_date_col = date(),
...
testthat::test_that("safety_02_population rejects missing required column arguments", {
  testthat::expect_error(safety_02_population(df = tibble::tibble(), epatient_15_col = "Age"),
                         "One or more of the \\*_col arguments is missing")
})

testthat::test_that("safety_02_population rejects non-dataframe inputs", {
  testthat::expect_error(safety_02_population(df = list()),
                         "One or more")

  testthat::expect_error(safety_02_population(patient_scene_table = matrix()),
                         "One or more")
})

testthat::test_that("safety_02_population validates date column formats", {
...
testthat::test_that("safety_02_population fails with unknown columns", {
  df <- tibble::tibble(
  ...
  testthat::expect_error(safety_02_population(df,
                                              erecord_01_col = erecord_01,
                                              epatient_15_col = epatient_15,
                                              epatient_16_col = epatient_16,
                                              eresponse_05_col = eresponse_05,
...
testthat::test_that("safety_02_population correctly classifies patient age", {
  ...
  result <- safety_02_population(df,
                                 erecord_01_col = erecord_01,
...
testthat::test_that("safety_02_population correctly filters 911 calls", {
...
testthat::test_that("safety_02_population runs correctly with table inputs", {
