testthat::test_that("airway_01 requires either df or all required tables", {
  testthat::expect_error(airway_01()) # No input provided
...
testthat::test_that("airway_01 correctly calculates proportions", {
  ...
  testthat::expect_true(all(
    c("pop", "numerator", "denominator", "prop", "prop_label") %in%
      colnames(result)
...
testthat::test_that("airway_01 correctly processes a dataframe", {
  ...
  # Run the function
  result <- suppressWarnings(airway_01(
    df = data,
    erecord_01_col = erecord_01,
    incident_date_col = incident_date,
    patient_DOB_col = patient_dob,
  ...
  testthat::expect_warning(airway_01(
    df = data,
    erecord_01_col = erecord_01,
    incident_date_col = incident_date,
    patient_DOB_col = patient_dob,
